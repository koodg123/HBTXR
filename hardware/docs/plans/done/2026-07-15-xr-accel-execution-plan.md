> **작성** 2026-07-15 · **갱신** 2026-07-29
> **상태** frozen — **반입만 됨. 실행 기록 없음** (완료가 아닙니다)
> **소유** hardware
>
> **XR_Accel 실행 계획.** `archive/hardware/docs/` 에서 복사, 내용 무변경.
>
> **`done/`에 있는 이유**: 더 이상 진행되지 않기 때문이지 끝났기 때문이 아닙니다. 여러
> 단계가 Vivado 실행을 요구하는데 [STATUS.md](../../STATUS.md)에서 Blocked이고, 결과를
> 가리킬 실험 디렉토리가 없습니다. 다시 하려면 새 날짜로 새 계획을 만듭니다.
...
- Remote target: `https://github.com/koodg123/XR_Accel`
- Current local repository target: `XR_Accel`
...
The repository currently keeps both:
...
3. push to `https://github.com/koodg123/XR_Accel`
