...
| 날짜 | 캠페인 | 문서 | 데이터 | 내용 |
|---|---|---:|---:|---|
| 06-06 | [cyclic-weight-layout](2026-06-06-cyclic-weight-layout/) | 2 | 6 | cyclic 가중치 레이아웃·패킹 확정 |
...
| **06-10** | [**final-signoff**](2026-06-10-final-signoff/) | **32** | **47** | 3차 목표 최종 서명 — 하루에 79개 산출 |
| 06-12 | [legacy-experiment](2026-06-12-legacy-experiment/) | 1 | — | 레거시 실험 분석 |
| **06-16** | [**third-goal-audit**](2026-06-16-third-goal-audit/) | **13** | 11 | req1/5/6/9 · 소스·게이트 감사 |
...
- 남은 상태값이 말해주는 것: `ready-for-board` 2 · `ready-for-physical-smoke` 2 ·
  ...
  항목이 여럿 대기 중**입니다.
- 06-06 → 07-01 사이 **한 달간 8개 캠페인**이 돌았고, 06-10과 06-16 두 날짜에 집중돼
  있습니다.
