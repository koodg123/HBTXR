...
static const int kExpectedFfDim = 256;
...
static const int kExpectedRaw[6] = {25, -6, 13, -5, 7, -8};
...
static const int kMlpW1ExtraEntriesCount = 12;
static const HgtxrMatrixEntry kMlpW1ExtraEntries[12] = {
  {0, 6, 2},
  {1, 7, -2},
  {2, 8, 3},
  {3, 9, -3},
...
static const int kMlpW2ExtraEntriesCount = 12;
static const HgtxrMatrixEntry kMlpW2ExtraEntries[12] = {
  {6, 2, -3},
  {7, 3, 2},
  {8, 4, -2},
  {9, 5, 3},
...
static const int kHeadExtraEntriesCount = 12;
static const HgtxrMatrixEntry kHeadExtraEntries[12] = {
  {0, 1, 2},
  {1, 2, -3},
  {2, 3, 5},
  {3, 4, -2},
