...
typedef ap_int   <  11 >   __attn_k_t;
typedef ap_int   <  11 >   __attn_v_t;
typedef ap_int   <  10 >   __attn_r_t;
typedef ap_int   <  11 >   __attn_a_t;
typedef ap_int   <  13 >   __attn_o_t;
...
typedef ap_int   <  15 >   __attn_of_t;    // output, not o matrix

// layernorm
typedef ap_int   <  15 >   __ln_sum_t;
typedef ap_int   <  31 >   __ln_divc_t;
typedef ap_int   <   8 >   __ln_mu_t;
...
const int attn_lnq_lnw_m_init [] = {
    #include "./refs/attn_0_lnq_lnw_m.txt"
};
const int attn_lnq_rsqrt_table_init [] = {
    #include "./refs/attn_0_lnq_rsqrt_table_m.txt"
};
const int attn_q_weight_init [C][C] = {
    #include "./refs/attn_0_gen_q_matmul_weight.txt"
};
const int attn_q_bias_init [C] = {
    #include "./refs/attn_0_gen_q_matmul_bias.txt"
};
const int attn_k_weight_init [C][C] = {
    // #include "./refs/attn_0_Iwk.txt"
    #include "./refs/attn_0_gen_k_matmul_weight.txt"
};
const int attn_k_bias_init [C] = {
    #include "./refs/attn_0_gen_k_matmul_bias.txt"
};
const int attn_v_weight_init [C][C] = {
    // #include "./refs/attn_0_Iwv.txt"
    #include "./refs/attn_0_gen_v_matmul_weight.txt"
};
const int attn_v_bias_init [C] = {
    #include "./refs/attn_0_gen_v_matmul_bias.txt"
};
...
const int attn_kq_scalars_init [] = {
    #include "./refs/attn_0_k_q_scalars.txt"
};
const int attn_kq_table_init [] = {
    #include "./refs/attn_0_k_q_table_m.txt"
};
const int attn_vq_scalars_init [] = {
    #include "./refs/attn_0_v_q_scalars.txt"
};
const int attn_vq_table_init [] = {
    #include "./refs/attn_0_v_q_table_m.txt"
};
const int attn_aq_scalars_init [] = {
    #include "./refs/attn_0_a_q_scalars.txt"
};
const int attn_aq_table_init [] = {
    #include "./refs/attn_0_a_q_table_m.txt"
};
...
const int attn_o_weight_init [C][C] = {
    // #include "./refs/attn_0_Iwo.txt"
    #include "./refs/attn_0_gen_o_matmul_weight.txt"
};
const int attn_o_bias_init [C] = {
    #include "./refs/attn_0_gen_o_matmul_bias.txt"
};


// test refs
const int x_ref[T][C] = {
    #include "./refs/attn_0_input.txt"
};
const int y_ref[T][C] = {
    #include "./refs/attn_0_output.txt"
};
...
const int lnq_ref[] = {
    #include "./refs/attn_0_lnq_output.txt"
};
const int q_ref[] = {
    #include "./refs/attn_0_gen_q_matmul_output.txt"
};
const int k_ref[] = {
    #include "./refs/attn_0_gen_k_matmul_output.txt"
};
const int v_ref[] = {
    #include "./refs/attn_0_gen_v_matmul_output.txt"
};
const int qq_ref[] = {
...
const int vq_ref[] = {
    #include "./refs/attn_0_vq_output.txt"
};

const int qq_split_ref[] = {
    #include "./refs/attn_0_gen_r_matmul_input.txt"
};
...
const int vq_split_ref[] = {
    #include "./refs/attn_0_gen_a_matmul_weight_transpose.txt"
};
...
const int kq_matmul_ref[] = {
    #include "./refs/attn_0_gen_r_matmul_output.txt"
};
...
const int vq_reshape_ref[] = {
    // #include "./refs/attn_0_gen_a_matmul_weight.txt"
    #include "./refs/attn_0_qq_output.txt"
};
...
const int rv_matmul_ref[] = {
    #include "./refs/attn_0_gen_a_matmul_output.txt"
};
...
const int a_ref[] = {
    #include "./refs/attn_0_gen_o_matmul_input.txt"
};

const int o_ref[] = {
    #include "./refs/attn_0_gen_o_matmul_output.txt"
};
