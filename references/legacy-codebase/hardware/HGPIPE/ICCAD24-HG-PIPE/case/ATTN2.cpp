...
typedef ap_int   <   9 >   __attn_q_t;
typedef ap_int   <   9 >   __attn_k_t;
typedef ap_int   <  10 >   __attn_v_t;
typedef ap_int   <  10 >   __attn_r_t;
typedef ap_int   <  10 >   __attn_a_t;
...
// qq
typedef ap_int   <   8 >   __qq_cursor_t;
const int QQ_ENTRIES = 64;

// kq
typedef ap_int   <   8 >   __kq_cursor_t;
const int KQ_ENTRIES = 64;

// vq
typedef ap_int   <   8 >   __vq_cursor_t;
...
// aq
typedef ap_int   <  10 >   __aq_cursor_t;
...
typedef ap_uint  <   8 >   __softmax_cursor1_t;            
typedef ap_uint  <  16 >   __softmax_exp_t;                
typedef ap_uint  <  23 >   __softmax_acc_t;                
...
const int attn_scalars_init [] = {
    #include "./refs/attn_2_scalars.txt"
};
const int attn_lnq_scalars_init [] = {
    #include "./refs/attn_2_lnq_scalars.txt"
};
const int64_t attn_lnq_lnb_m_init [] = {
    #include "./refs/attn_2_lnq_lnb_m.txt"
};
const int attn_lnq_lnw_m_init [] = {
    #include "./refs/attn_2_lnq_lnw_m.txt"
};
const int attn_lnq_rsqrt_table_init [] = {
    #include "./refs/attn_2_lnq_rsqrt_table_m.txt"
};
const int attn_q_weight_init [C][C] = {
    #include "./refs/attn_2_gen_q_matmul_weight.txt"
};
const int attn_q_bias_init [C] = {
    #include "./refs/attn_2_gen_q_matmul_bias.txt"
};
const int attn_k_weight_init [C][C] = {
    // #include "./refs/attn_2_Iwk.txt"
    #include "./refs/attn_2_gen_k_matmul_weight.txt"
};
const int attn_k_bias_init [C] = {
    #include "./refs/attn_2_gen_k_matmul_bias.txt"
};
const int attn_v_weight_init [C][C] = {
    // #include "./refs/attn_2_Iwv.txt"
    #include "./refs/attn_2_gen_v_matmul_weight.txt"
};
const int attn_v_bias_init [C] = {
    #include "./refs/attn_2_gen_v_matmul_bias.txt"
};
const int attn_qq_scalars_init [] = {
    #include "./refs/attn_2_q_q_scalars.txt"
};
const int attn_qq_table_init [] = {
    #include "./refs/attn_2_q_q_table_m.txt"
};
const int attn_kq_scalars_init [] = {
    #include "./refs/attn_2_k_q_scalars.txt"
};
const int attn_kq_table_init [] = {
    #include "./refs/attn_2_k_q_table_m.txt"
};
const int attn_vq_scalars_init [] = {
    #include "./refs/attn_2_v_q_scalars.txt"
};
const int attn_vq_table_init [] = {
    #include "./refs/attn_2_v_q_table_m.txt"
};
const int attn_aq_scalars_init [] = {
    #include "./refs/attn_2_a_q_scalars.txt"
};
const int attn_aq_table_init [] = {
    #include "./refs/attn_2_a_q_table_m.txt"
};
const int attn_softmax_scalars_init [] = {
    #include "./refs/attn_2_softmaxq_scalars.txt"
};
const int attn_softmax_exp_table_init [] = {
    #include "./refs/attn_2_softmaxq_exp_opp_table_m.txt"
};
const int attn_softmax_recip_table_one_init [] = {
    #include "./refs/attn_2_softmaxq_recip_scaled_table_m_one.txt"
};
const int attn_softmax_recip_table_two_init [] = {
    #include "./refs/attn_2_softmaxq_recip_scaled_table_m_two.txt"
};
const int attn_o_weight_init [C][C] = {
    // #include "./refs/attn_2_Iwo.txt"
    #include "./refs/attn_2_gen_o_matmul_weight.txt"
};
const int attn_o_bias_init [C] = {
    #include "./refs/attn_2_gen_o_matmul_bias.txt"
};


// test refs
const int x_ref[T][C] = {
    #include "./refs/attn_2_input.txt"
};
const int y_ref[T][C] = {
    #include "./refs/attn_2_output.txt"
};
...
const int lnq_ref[] = {
    #include "./refs/attn_2_lnq_output.txt"
};
const int q_ref[] = {
    #include "./refs/attn_2_gen_q_matmul_output.txt"
};
const int k_ref[] = {
    #include "./refs/attn_2_gen_k_matmul_output.txt"
};
const int v_ref[] = {
    #include "./refs/attn_2_gen_v_matmul_output.txt"
};
const int qq_ref[] = {
    #include "./refs/attn_2_qq_output.txt"
};
const int kq_ref[] = {
    #include "./refs/attn_2_kq_output.txt"
};
const int vq_ref[] = {
    #include "./refs/attn_2_vq_output.txt"
};

const int qq_split_ref[] = {
    #include "./refs/attn_2_gen_r_matmul_input.txt"
};
...
const int kq_split_ref[] = {
    #include "./refs/attn_2_gen_r_matmul_weight.txt"
};
...
const int vq_split_ref[] = {
    #include "./refs/attn_2_gen_a_matmul_weight_transpose.txt"
};
...
const int kq_matmul_ref[] = {
    #include "./refs/attn_2_gen_r_matmul_output.txt"
};
...
const int softmax_ref[] = {
    #include "./refs/attn_2_softmaxq_output.txt"
};
...
const int vq_reshape_ref[] = {
    // #include "./refs/attn_2_gen_a_matmul_weight.txt"
    #include "./refs/attn_2_qq_output.txt"
};
...
const int rv_matmul_ref[] = {
    #include "./refs/attn_2_gen_a_matmul_output.txt"
};
...
const int a_ref[] = {
    #include "./refs/attn_2_gen_o_matmul_input.txt"
};

const int o_ref[] = {
    #include "./refs/attn_2_gen_o_matmul_output.txt"
};
