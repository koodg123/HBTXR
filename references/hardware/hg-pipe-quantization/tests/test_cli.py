...
from src.run_result import make_inference_result
...
class CliTest(unittest.TestCase):
    ...
    def test_parser_exposes_package_runtime_commands(self):
        ...
        self.assertIn("calibrate-lut-npy", help_text)
        self.assertIn("quantize-group-vector-npy", help_text)
        self.assertIn("calibrate-linear-dyadic-npy", help_text)
...
class ArtifactPatchMatrixIngestCliAppendTest(unittest.TestCase):
    def test_ingest_artifact_patch_matrix_assets_cli_smoke(self):
        from src.artifact_patch import expected_artifact_patch_matrix_manifest
