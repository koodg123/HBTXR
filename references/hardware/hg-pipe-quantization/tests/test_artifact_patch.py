...
from src.artifact_patch import (
...
class ArtifactPatchTest(unittest.TestCase):
    ...
    def test_evaluate_patch_batch_selects_requested_flow_and_preserves_shapes(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("src.api.HgPipeQuantizationPackage", return_value=self._fake_package()):
...
from src.artifact_patch import validate_artifact_patch_matrix_manifest
...
from src.artifact_patch import expected_artifact_patch_matrix_manifest, validate_artifact_patch_matrix_manifest
...
from src.artifact_patch import ingest_artifact_patch_matrix_assets, load_artifact_patch_asset_source_manifest
...
from src.artifact_patch import run_artifact_patch_matrix_pipeline
...
class ArtifactPatchMatrixPipelineAppendTest(unittest.TestCase):
    ...
    def test_run_artifact_patch_matrix_pipeline_runs_matrix_after_valid_ingest(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("src.artifact_patch.evaluate_artifact_patch_matrix_manifest", return_value=self._pipeline_rows()) as matrix_eval:
    ...
    def test_run_artifact_patch_matrix_pipeline_skips_matrix_when_manifest_invalid(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("src.artifact_patch.evaluate_artifact_patch_matrix_manifest") as matrix_eval:
                payload = run_artifact_patch_matrix_pipeline(
                    "unused-source",
                    manifest=manifest,
                    matrix_report=matrix_report,
...
from src.artifact_patch import write_artifact_patch_asset_source_manifest_from_directory
