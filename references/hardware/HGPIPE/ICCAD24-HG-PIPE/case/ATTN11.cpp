...
const int attn_scalars_init [] = {
    #include "./refs/attn_11_scalars.txt"
};
const int attn_lnq_scalars_init [] = {
    #include "./refs/attn_11_lnq_scalars.txt"
};
const int64_t attn_lnq_lnb_m_init [] = {
    #include "./refs/attn_11_lnq_lnb_m.txt"
};
const int attn_lnq_lnw_m_init [] = {
    #include "./refs/attn_11_lnq_lnw_m.txt"
};
const int attn_lnq_rsqrt_table_init [] = {
    #include "./refs/attn_11_lnq_rsqrt_table_m.txt"
};
const int attn_q_weight_init [C][C] = {
    #include "./refs/attn_11_gen_q_matmul_weight.txt"
};
const int attn_q_bias_init [C] = {
    #include "./refs/attn_11_gen_q_matmul_bias.txt"
};
const int attn_k_weight_init [C][C] = {
    // #include "./refs/attn_11_Iwk.txt"
    #include "./refs/attn_11_gen_k_matmul_weight.txt"
};
const int attn_k_bias_init [C] = {
    #include "./refs/attn_11_gen_k_matmul_bias.txt"
};
const int attn_v_weight_init [C][C] = {
    // #include "./refs/attn_11_Iwv.txt"
    #include "./refs/attn_11_gen_v_matmul_weight.txt"
};
const int attn_v_bias_init [C] = {
    #include "./refs/attn_11_gen_v_matmul_bias.txt"
};
const int attn_qq_scalars_init [] = {
    #include "./refs/attn_11_q_q_scalars.txt"
};
const int attn_qq_table_init [] = {
    #include "./refs/attn_11_q_q_table_m.txt"
};
const int attn_kq_scalars_init [] = {
    #include "./refs/attn_11_k_q_scalars.txt"
};
const int attn_kq_table_init [] = {
    #include "./refs/attn_11_k_q_table_m.txt"
};
const int attn_vq_scalars_init [] = {
    #include "./refs/attn_11_v_q_scalars.txt"
};
const int attn_vq_table_init [] = {
    #include "./refs/attn_11_v_q_table_m.txt"
};
const int attn_aq_scalars_init [] = {
    #include "./refs/attn_11_a_q_scalars.txt"
};
const int attn_aq_table_init [] = {
    #include "./refs/attn_11_a_q_table_m.txt"
};
const int attn_softmax_scalars_init [] = {
    #include "./refs/attn_11_softmaxq_scalars.txt"
};
const int attn_softmax_exp_table_init [] = {
    #include "./refs/attn_11_softmaxq_exp_opp_table_m.txt"
};
const int attn_softmax_recip_table_one_init [] = {
    #include "./refs/attn_11_softmaxq_recip_scaled_table_m_one.txt"
};
const int attn_softmax_recip_table_two_init [] = {
    #include "./refs/attn_11_softmaxq_recip_scaled_table_m_two.txt"
};
const int attn_o_weight_init [C][C] = {
    // #include "./refs/attn_11_Iwo.txt"
    #include "./refs/attn_11_gen_o_matmul_weight.txt"
};
const int attn_o_bias_init [C] = {
    #include "./refs/attn_11_gen_o_matmul_bias.txt"
};


// test refs
const int x_ref[T][C] = {
    #include "./refs/attn_11_input.txt"
};
const int y_ref[T][C] = {
    #include "./refs/attn_11_output.txt"
};
...
const int lnq_ref[] = {
    #include "./refs/attn_11_lnq_output.txt"
};
const int q_ref[] = {
    #include "./refs/attn_11_gen_q_matmul_output.txt"
};
const int k_ref[] = {
    #include "./refs/attn_11_gen_k_matmul_output.txt"
};
const int v_ref[] = {
    #include "./refs/attn_11_gen_v_matmul_output.txt"
};
const int qq_ref[] = {
    #include "./refs/attn_11_qq_output.txt"
};
const int kq_ref[] = {
    #include "./refs/attn_11_kq_output.txt"
};
const int vq_ref[] = {
    #include "./refs/attn_11_vq_output.txt"
};

const int qq_split_ref[] = {
    #include "./refs/attn_11_gen_r_matmul_input.txt"
};
...
const int kq_split_ref[] = {
    #include "./refs/attn_11_gen_r_matmul_weight.txt"
};
...
const int vq_split_ref[] = {
    #include "./refs/attn_11_gen_a_matmul_weight_transpose.txt"
};
...
const int kq_matmul_ref[] = {
    #include "./refs/attn_11_gen_r_matmul_output.txt"
};
...
const int softmax_ref[] = {
    #include "./refs/attn_11_softmaxq_output.txt"
};
...
const int vq_reshape_ref[] = {
    // #include "./refs/attn_11_gen_a_matmul_weight.txt"
    #include "./refs/attn_11_qq_output.txt"
};
...
const int rv_matmul_ref[] = {
    #include "./refs/attn_11_gen_a_matmul_output.txt"
};
...
const int a_ref[] = {
    #include "./refs/attn_11_gen_o_matmul_input.txt"
};

const int o_ref[] = {
    #include "./refs/attn_11_gen_o_matmul_output.txt"
};
