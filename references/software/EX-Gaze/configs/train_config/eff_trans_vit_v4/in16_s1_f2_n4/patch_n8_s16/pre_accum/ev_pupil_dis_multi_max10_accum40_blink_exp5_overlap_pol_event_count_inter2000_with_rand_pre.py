...
with read_base():
    ...
    from configs.dataset_config.pre_accum_pol_even_count_inter2000.patch_n8_s16.multi_max10_accum40_blink_exp5_ev_overlap_pupil_disp_with_rand_pre import \
...
model.data_preprocessor.update(
    mean=[0.00099458, 0.00086193],std= [0.03178884, 0.02971749]
)
