...
LOG_FILE="${LOG_DIR}/HBTXR_img128_patch4_gpu0_train_2026-06-27.log"
CONFIG="DavisEyeEllipse_HBTXR_full_unet_img128_patch4.yaml"
...
echo "[$(date --iso-8601=seconds)] starting HBTXR img128 patch4 training on GPU0" | tee -a "${LOG_FILE}"
cd "${FACET_ROOT}"
...
export PYTHONPYCACHEPREFIX=/tmp/facet_hbtxr_img128_patch4_pycache

echo "[$(date --iso-8601=seconds)] running img128 patch4 smoke check" | tee -a "${LOG_FILE}"
...
cfg = load_config("DavisEyeEllipse_HBTXR_full_unet_img128_patch4.yaml")
