...
EP_LAUNCHER="$REPORT_ROOT/run_epnet_full_unet_gpu0_when_ready_2026-06-26.sh"
HB_LAUNCHER="$REPORT_ROOT/run_hbtxr_full_unet_gpu1_when_ready_2026-06-26.sh"
EVAL_WATCHER="$REPORT_ROOT/watch_full_checkpoints_and_evaluate_2026-06-26.sh"
