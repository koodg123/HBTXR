...
SUMMARY_PY="$OPERATIONS_ROOT/summarize_missing_gates_2026-06-26.py"
...
AUDIT_MD="$TRAINING_ROOT/FACET_reproduction_completion_audit_2026-06-26.md"
MISSING_SUMMARY_MD="$EVALUATION_ROOT/FACET_missing_gate_summary_2026-06-26.md"
...
mkdir -p "$REPORT_ROOT" "$OPERATIONS_ROOT" "$ANALYSIS_ROOT" "$TRAINING_ROOT" "$EVALUATION_ROOT"
touch "$LOG"
