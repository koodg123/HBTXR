...
check_waiter \
  "$OPERATIONS_ROOT/run_epnet_fpn_dw_full_unet_gpu0_after_baseline_2026-06-26.sh" \
  "FACET_FPN_DW_WAIT_BASELINE_COMPLETE" \
  "EPNet_full_unet_gpu0_train_2026-06-26.log" \
  "waiting for baseline EPNet completion marker"

check_waiter \
  "$OPERATIONS_ROOT/run_hbtxr_full_unet_effbs32_gpu1_after_baseline_2026-06-26.sh" \
