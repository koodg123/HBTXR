...
from swift_hbtxr.trainer import build_model, epoch_loop, load_checkpoint, make_loader, resolve_device_and_wrap


def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate a SWIFT-HBTXR checkpoint")
