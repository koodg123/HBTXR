...
- Active slice: AM-020 dataset owner migration.
- Completed: AM-000 baseline/preservation lock and AM-010 package/import
  contract; isolated worktree created at baseline SHA; clean checkout verified;
...
- Pending: AM-030, AM-040, AM-050, AM-060, AM-070,
...
- Next: execute AM-020 without committing the transient dual-case source state.
...
- Decision: continue to AM-020. Final regression remains an AM-900 obligation.
