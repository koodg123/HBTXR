...
from hybrid.utils.external_packages import default_external_repo_roots
from hybrid.utils.paths import normalize_user_path, resolve_stored_path as _resolve_stored_path
