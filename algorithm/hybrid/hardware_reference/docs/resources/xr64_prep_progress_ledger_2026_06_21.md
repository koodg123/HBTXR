...
| Source authority | `docs/resources/xr64_resume_command_manifest_2026_06_20.json` and `scripts/external/emit_xr64_next_prep_command.py` |
...
| Verification | `.venv/bin/python scripts/external/check_xr64_prep_progress_ledger.py --format summary` |
