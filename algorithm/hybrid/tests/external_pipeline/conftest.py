...
@pytest.fixture
def tmp_path() -> Path:
    temp_root = Path(tempfile.gettempdir()) / "hbtxr_pytest"
    temp_root.mkdir(parents=True, exist_ok=True)
    path = temp_root / f"hbtxr_case_{uuid.uuid4().hex[:8]}"
    ...
    write_json(
        {
            ...
            "frame_index_path": "sessions/user01/left/session_101/labels/frame_index.jsonl",
        ...
        [
            {
                ...
                "eye": "left",
                "session_code": "101",
                "session_package_path": session_package_rel,
                "annotation_store_path": annotation_store_rel,
                "events_npz": "sessions/user01/left/session_101/events/events.npz",
                "sensor_size_wh": sensor_size_wh,
                "eye_region_xywh": roi_xywh,
...
@pytest.fixture
def synthetic_raw_workspace(tmp_path: Path) -> dict[str, Path]:
    project_root = tmp_path / "project"
