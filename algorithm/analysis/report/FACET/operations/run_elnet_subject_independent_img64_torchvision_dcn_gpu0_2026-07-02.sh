...
LOG_FILE="${REPORT_ROOT}/operations/elnet_subject_independent_img64_torchvision_dcn_gpu0_2026-07-02.log"
...
export PYTHONPYCACHEPREFIX=/tmp/facet_elnet_subject_independent_img64_gpu0_pycache

{
  echo "[$(date --iso-8601=seconds)] starting ElNet subject-independent img64 training on GPU0"
