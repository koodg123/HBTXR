...
PLANNING_ROOT = REPORT_ROOT / "planning"
...
def main():
    ...
    parser.add_argument(
        "--plan",
        type=Path,
        default=PLANNING_ROOT / "FACET_reproduction_plan_2026-06-25.md",
    )
    parser.add_argument(
        "--status-json",
        type=Path,
        default=OPERATIONS_ROOT / "FACET_reproduction_status_2026-06-26.json",
    )
    parser.add_argument(
        "--output-json",
        type=Path,
        default=OPERATIONS_ROOT / "FACET_reproduction_completion_audit_2026-06-26.json",
    )
    parser.add_argument(
        "--output-md",
        type=Path,
        default=TRAINING_ROOT / "FACET_reproduction_completion_audit_2026-06-26.md",
    )
    parser.add_argument(
        "--fail-on-incomplete",
        action="store_true",
