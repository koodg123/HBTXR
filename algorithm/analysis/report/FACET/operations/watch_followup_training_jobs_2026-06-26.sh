...
FPN_DW_LAUNCHER="$OPERATIONS_ROOT/run_epnet_fpn_dw_full_unet_gpu0_after_baseline_2026-06-26.sh"
FPN_DW_EVAL_WATCHER="$OPERATIONS_ROOT/watch_epnet_fpn_dw_checkpoints_and_evaluate_2026-06-26.sh"
EFFBS32_LAUNCHER="$OPERATIONS_ROOT/run_hbtxr_full_unet_effbs32_gpu1_after_baseline_2026-06-26.sh"
EFFBS32_EVAL_WATCHER="$OPERATIONS_ROOT/watch_hbtxr_effbs32_checkpoints_and_evaluate_2026-06-26.sh"
