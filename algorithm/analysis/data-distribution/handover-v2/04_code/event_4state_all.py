...
USERS_TEST=list(range(1,49)); STATES=["Fixation","Saccade","Smooth","Blink"]
CACHE=os.path.join(CACHE_DIR,"event_4state_all48.csv")
...
def main():
    ...
    out.to_csv(os.path.join(REPORTS_DIR,"tbl_event_4state_all48.csv"),index=False)
    ...
    try:
        ...
        plt.tight_layout(); plt.savefig(os.path.join(REPORTS_DIR,"fig_event_4state_all48.png"),dpi=130); print("WROTE fig")
