...
MODEL_CLASSES: dict[str, tuple[str, str]] = dict(
    DeepLabV3=("eveye.common.models.DavisWithMask.DeepLabV3", "DeepLabV3"),
    ConvLSTM=("eveye.common.models.CitiBike.ConvLSTM", "ConvLSTM"),
    TennSt=("eveye.event.models.TennSt", "TennSt"),
    EPNet=("eveye.event.models.EPNet.EPNet", "EPNet"),
    HBTXR=("eveye.common.models.DavisEyeEllipse.HBTXR.HBTXR", "HBTXR"),
    ElNet=("eveye.event.models.ElNet.ElNet", "Creat_MyNet"),
    UNet=("eveye.common.models.DavisEyeEllipse.UNet.UNet", "UNet"),
)
