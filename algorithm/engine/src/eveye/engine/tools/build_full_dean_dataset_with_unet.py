...
from eveye.common.models.DavisEyeEllipse.UNet.UNet import UNet
from eveye.engine.tools.build_dean_dataset_from_ev_eye import (
    ELLIPSE_DTYPE,
    EVENT_DTYPE,
    create_memmap,
    ellipse_from_mask,
...
def main():
    ...
    parser.add_argument(
        "--checkpoint",
        type=Path,
        help="Lightning checkpoint for eveye.common.models.DavisEyeEllipse.UNet.UNet.",
    )
    parser.add_argument(
        "--output-root",
        type=Path,
