...
if _DCN_IMPL == "native":
    ...
    from eveye.event.models.ElNet.torchvision_dcn import DCN
...
from eveye.event.models.EPNet.Loss import *
from eveye.event.models.EPNet.Predict import *
from eveye.event.models.EPNet.Metric import *
...
class Creat_DlaNet(nn.Module):
    def __init__(
        ...
        # globals()[base_name](pretrained=pretrained) means looking up a function or class named base_name in the global namespace,
        # with the pretrained argument set to true
...
def main():
    ...
    batch_size = 32
    input_channels = 3  # Assume the input is an RGB image
