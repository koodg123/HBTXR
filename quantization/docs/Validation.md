...
- `python3 -m src.cli verify` reports all discovered cases passed with zero mismatches.

## Artifact-backed graph verification - 2026-06-09

Commands:

- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-graph --json reports/graph_verification.json
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-e2e --json reports/e2e_graph_verification.json
- .venv/bin/python -m unittest discover -s tests
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-int --json reports/torch_int_verification.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-fakequant --json reports/fakequant_verification.json
- .venv/bin/python -m unittest discover -s tests
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE trace-fakequant --json reports/fakequant_trace.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE trace-int-cases --json reports/torch_int_case_trace.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE compare-traces --left reports/fakequant_trace.json --right reports/torch_int_case_trace.json --json reports/fakequant_vs_int.json --markdown reports/fakequant_vs_int.md
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-fakequant-graph --json reports/fakequant_graph_verification.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE trace-fakequant-graph --json reports/fakequant_graph_trace.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE compare-traces --left reports/fakequant_graph_trace.json --right reports/torch_int_case_trace.json --json reports/fakequant_graph_vs_int.json --markdown reports/fakequant_graph_vs_int.md
- .venv/bin/python -m unittest discover -s tests
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-int --json reports/run_int_result.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-fakequant-graph --json reports/run_fakequant_graph_result.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE compare-run-results --left reports/run_fakequant_graph_result.json --right reports/run_int_result.json --json reports/run_result_comparison.json
- .venv/bin/python -m unittest discover -s tests
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-graph --json reports/graph_verification.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-e2e --json reports/e2e_graph_verification.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-int --json reports/torch_int_verification.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE verify-fakequant --json reports/fakequant_verification.json
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE export-contracts --json reports/quant_contracts.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE export-contracts --kind requant_table --include-tables --json reports/requant_contracts_with_tables.json
- .venv/bin/python -m unittest discover -s tests
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-compare --json reports/run_compare_result.json --markdown reports/run_compare_result.md --topk 5
...
- .venv/bin/python -m unittest tests.test_cli
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-compare-image-npy --image-npy reports/smoke_zero_image.npy --scale 1.0 --json reports/run_compare_image_result.json --markdown reports/run_compare_image_result.md --topk 3
...
- .venv/bin/python -m src.cli estimate-input-scale-npy --images-npy reports/smoke_scale_images.npy --json reports/input_scale_estimate.json
...
- .venv/bin/python -m src.cli audit-completion --json reports/completion_audit.json --markdown reports/completion_audit.md
...
- .venv/bin/python -m py_compile src/cli.py src/completion_audit.py
- .venv/bin/python -m unittest tests.test_cli tests.test_completion_audit
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE audit-completion --refresh --json reports/completion_audit.json --markdown reports/completion_audit.md
...
- .venv/bin/python -m py_compile src/completion_audit.py
...
- .venv/bin/python -m py_compile src/eval/imagenet_eval.py src/completion_audit.py
- .venv/bin/python -m unittest tests.test_completion_audit
- .venv/bin/python -m src.cli audit-completion --json reports/completion_audit.json --markdown reports/completion_audit.md
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-artifact-image-batch-npy --images-npy reports/smoke_artifact_images.npy --labels-npy reports/smoke_artifact_labels.npy --scale 1.0 --json reports/artifact_imagenet_accuracy.json --topk 5
...
- .venv/bin/python -m src.cli validate-artifact-imagenet-report --report reports/artifact_imagenet_accuracy.json --json reports/artifact_imagenet_validation.json --markdown reports/artifact_imagenet_validation.md
...
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-artifact-patch-batch-npy --patch-inputs-npy reports/smoke_patch_inputs.npy --labels-npy reports/smoke_patch_labels.npy --model deit_tiny_patch16_224 --precision int8 --json reports/artifact_patch_smoke_accuracy.json --topk 5
...
- .venv/bin/python -m src.cli write-artifact-patch-matrix-template --json configs/artifact_patch_matrix_manifest.template.json
- .venv/bin/python -m src.cli --source ../ICCAD24-HG-PIPE run-artifact-patch-matrix-npy --manifest reports/artifact_patch_smoke_manifest.json --json reports/artifact_patch_smoke_matrix_accuracy.json --topk 5
- .venv/bin/python -m src.cli validate-artifact-imagenet-report --report reports/artifact_patch_smoke_matrix_accuracy.json --json reports/artifact_patch_smoke_matrix_validation.json --markdown reports/artifact_patch_smoke_matrix_validation.md
...
- .venv/bin/python -m src.cli validate-artifact-patch-matrix-manifest --manifest configs/artifact_patch_matrix_manifest.template.json --json reports/artifact_patch_matrix_manifest_validation.json --markdown reports/artifact_patch_matrix_manifest_validation.md
