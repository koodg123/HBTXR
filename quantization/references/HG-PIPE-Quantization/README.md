...
~~~bash
python3 -m src.cli audit-completion --refresh
python3 -m src.cli audit-completion
python3 -m src.cli list --limit 10
python3 -m src.cli verify
python3 -m src.cli verify-graph
python3 -m src.cli verify-e2e
python3 -m src.cli verify-int
python3 -m src.cli verify-fakequant
python3 -m src.cli verify-fakequant-graph
python3 -m src.cli export-contracts
python3 -m src.cli run-int
python3 -m src.cli run-fakequant-graph
python3 -m src.cli run-compare
python3 -m src.cli estimate-input-scale-npy --images-npy reports/smoke_scale_images.npy
python3 -m src.cli run-compare-image-npy --image-npy reports/smoke_zero_image.npy --scale 1.0
python3 -m src.cli run-artifact-image-batch-npy --images-npy reports/smoke_artifact_images.npy --labels-npy reports/smoke_artifact_labels.npy --scale 1.0
python3 -m src.cli run-artifact-patch-batch-npy --patch-inputs-npy reports/smoke_patch_inputs.npy --labels-npy reports/smoke_patch_labels.npy --model deit_tiny_patch16_224 --precision int8
python3 -m src.cli write-artifact-patch-matrix-template --json configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli validate-artifact-patch-matrix-manifest --manifest configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli run-artifact-patch-matrix-npy --manifest reports/artifact_patch_smoke_manifest.json --json reports/artifact_patch_smoke_matrix_accuracy.json
python3 -m src.cli validate-artifact-imagenet-report --report reports/artifact_imagenet_accuracy.json
python3 -m src.cli check-paper-equivalence-assets
python3 -m src.cli compare-run-results --left reports/run_fakequant_graph_result.json --right reports/run_int_result.json
python3 -m src.cli trace-fakequant-graph
python3 -m src.cli trace-int-cases
python3 -m src.cli trace-fakequant
python3 -m src.cli compare-traces --left reports/fakequant_graph_trace.json --right reports/torch_int_case_trace.json
~~~
...
Command: python3 -m src.cli run-artifact-image-batch-npy --images-npy reports/smoke_artifact_images.npy --labels-npy reports/smoke_artifact_labels.npy --scale 1.0
python3 -m src.cli run-artifact-patch-batch-npy --patch-inputs-npy reports/smoke_patch_inputs.npy --labels-npy reports/smoke_patch_labels.npy --model deit_tiny_patch16_224 --precision int8
python3 -m src.cli write-artifact-patch-matrix-template --json configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli validate-artifact-patch-matrix-manifest --manifest configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli run-artifact-patch-matrix-npy --manifest reports/artifact_patch_smoke_manifest.json --json reports/artifact_patch_smoke_matrix_accuracy.json
...
Command: python3 -m src.cli run-artifact-patch-batch-npy --patch-inputs-npy reports/smoke_patch_inputs.npy --labels-npy reports/smoke_patch_labels.npy --model deit_tiny_patch16_224 --precision int8
python3 -m src.cli write-artifact-patch-matrix-template --json configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli validate-artifact-patch-matrix-manifest --manifest configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli run-artifact-patch-matrix-npy --manifest reports/artifact_patch_smoke_manifest.json --json reports/artifact_patch_smoke_matrix_accuracy.json
...
Command: python3 -m src.cli write-artifact-patch-matrix-template --json configs/artifact_patch_matrix_manifest.template.json
python3 -m src.cli validate-artifact-patch-matrix-manifest --manifest configs/artifact_patch_matrix_manifest.template.json

Command: python3 -m src.cli run-artifact-patch-matrix-npy --manifest reports/artifact_patch_smoke_manifest.json --json reports/artifact_patch_smoke_matrix_accuracy.json
...
Command: python3 -m src.cli validate-artifact-imagenet-report --report reports/artifact_imagenet_accuracy.json
...
Command: python3 -m src.cli check-paper-equivalence-assets
...
The ImageNet evaluation path now instantiates deit_tiny_patch16_224, deit_small_patch16_224, and vit_tiny_patch16_224 from pure torch.nn modules under src/models/vision_transformer.py. timm is no longer required to construct these three models. Optional checkpoint loading is available through src.eval.model_registry.create_paper_model and python -m src.eval.imagenet_eval --checkpoint PATH; without a checkpoint, evaluation runs with deterministic random initialization and reports pretrained=false.
