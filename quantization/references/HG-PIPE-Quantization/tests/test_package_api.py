...
from src import HgPipeQuantizationPackage, QuantParamStore, TorchIntGraphRunner, evaluate_artifact_image_batch_npy, evaluate_artifact_patch_batch_npy, evaluate_artifact_patch_matrix_manifest, validate_artifact_patch_matrix_manifest
from src.graph import ArtifactGraphRunner
...
class PackageApiTest(unittest.TestCase):
    ...
    def test_top_level_exports_core_package_api(self):
        ...
        self.assertIs(TorchIntGraphRunner, __import__("src").TorchIntGraphRunner)
    ...
    def test_top_level_exports_artifact_patch_matrix_api(self):
        ...
        self.assertIs(evaluate_artifact_patch_matrix_manifest, __import__("src").evaluate_artifact_patch_matrix_manifest)
        self.assertIs(validate_artifact_patch_matrix_manifest, __import__("src").validate_artifact_patch_matrix_manifest)
    ...
    def test_package_evaluates_artifact_patch_batch_npy(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIs(evaluate_artifact_patch_batch_npy, __import__("src").evaluate_artifact_patch_batch_npy)
    ...
    def test_package_evaluates_artifact_image_batch_npy(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertTrue(payload["runner_comparison_passed"])
            self.assertIs(evaluate_artifact_image_batch_npy, __import__("src").evaluate_artifact_image_batch_npy)
