...
- Added src/input_bridge.py for experimental normalized-image tensor to signed-int8 patch input conversion.
...
- Added src.api.HgPipeQuantizationPackage as a high-level package entry point.
- Exported core runners, FakeQuantizers, quant parameter dataclasses, and run-result helpers from src.__init__.
...
- Added run-artifact-image-batch-npy CLI and src.artifact_imagenet helpers.
...
- Added src.paper_equivalence scanner and check-paper-equivalence-assets CLI.
