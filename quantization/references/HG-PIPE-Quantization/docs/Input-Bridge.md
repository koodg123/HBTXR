...
python3 -m src.cli --source ../ICCAD24-HG-PIPE run-compare-image-npy --image-npy reports/smoke_zero_image.npy --scale 1.0 --json reports/run_compare_image_result.json --markdown reports/run_compare_image_result.md
...
python3 -m src.cli estimate-input-scale-npy --images-npy reports/smoke_scale_images.npy --json reports/input_scale_estimate.json
